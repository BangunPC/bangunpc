...
import kerehore from "public/kerehore.webp";
import mending from "public/mending.webp";
import sulthan from "public/sulthan.webp";
  ...
  return (
    <>
      ...
      <section className="flex flex-col mb-12">
        ...
        {[kerehore, mending, sulthan].map((image, index) => (
          <>
            <div
