...
export default function HomePage() {
  ...
  useLayoutEffect(() => {
    let ctx = gsap.context(() => {
      gsap.from(".jumbotron-image", {
        opacity: 1,
        duration: 1,
        y: 55,
      });

      gsap.from(".jumbotron-text", {
        opacity: 0,
        duration: 1,
        y: 70,
      });
      ...
      gsap.from(".section-content-animate", {
        delay: 2,
        opacity: 0,
        duration: 1,
        x: 100,
        scrollTrigger: {
          trigger: ".section-content-animate",
          start: "left center",
          end: "right center",
          scrub: true,
        },
      ...
      gsap.from(".section-title-animate2", {
        delay: 2,
        opacity: 0,
        duration: 1,
        y: -100,
      ...
      gsap.from(".section-content-animate2", {
        delay: 2,
        opacity: 0,
        duration: 1,
        x: 100,
        scrollTrigger: {
          trigger: ".section-content-animate2",
          start: "left center",
          end: "right center",
          scrub: true,
        },
      });
      gsap.from(".section-content-animate3", {
        delay: 2,
        opacity: 0,
        duration: 1,
        x: 100,
        scrollTrigger: {
          trigger: ".section-content-animate3",
          start: "left center",
          end: "right center",
          scrub: true,
        },
      });
      gsap.from(".section-content-animate4", {
        delay: 2,
        opacity: 0,
        duration: 1,
        x: 100,
        scrollTrigger: {
          trigger: ".section-content-animate4",
          start: "left center",
          end: "right center",
          scrub: true,
        },
