...
const StarRating = (props: { rating: number }) => {
    ...
    return (
        <div className="flex mx-auto w-full items-center text-yellow-400">
            {Array.from({ length: fullStars }, (_, __) => (
                <svg xmlns="http://www.w3.org/2000/svg" width={24} height={24} viewBox="0 0 24 24" stroke-width={1} stroke="currentColor" fill="none" strokeLinecap="round" strokeLinejoin="round">
            ...
            {Array.from({ length: 5 - Math.ceil(rating) }, (_, index) => (
                <svg xmlns="http://www.w3.org/2000/svg" className="icon icon-tabler icon-tabler-star" width={24} height={24} viewBox="0 0 24 24" stroke-width={2} stroke="currentColor" fill="none" strokeLinecap="round" strokeLinejoin="round">
                    <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
