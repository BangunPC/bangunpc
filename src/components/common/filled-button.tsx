...
export const filledButtonClass =
  'rounded-md bg-button text-white font-semibold text-lg px-2 py-1 transition-colors duration-200 hover:bg-button-hover ';
...
export default component$<ButtonProps>((props) => {
  ...
  if (props.labelFor) {
    return (
      <label class={componentClass + ' cursor-pointer'} for={props.labelFor}>
        <Slot />
      </label>
    );
  } else {
