...
export default component$<IconProps>((props) => (
    ...
    >
        <path d="M12.16 10.87C12.06 10.86 11.94 10.86 11.83 10.87C9.45 10.79 7.56 8.84 7.56 6.44C7.56 3.99 9.54 2 12 2C14.45 2 16.44 3.99 16.44 6.44C16.43 8.84 14.54 10.79 12.16 10.87Z" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
