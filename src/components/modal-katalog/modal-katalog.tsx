...
export default component$(() => {
  ...
  return (
    <>
      <input
        type="checkbox"
        id={kToggleKatalogModal}
        class={style.toggleKatalogModal}
        hidden
      />
      <div class={style['modal-katalog']}>
        <label
          for={kToggleKatalogModal}
          class={style.toggleKatalogModalLabel}
        />
        <div class={style['modal-katalog-content']}>
          ...
          <input
            type="checkbox"
            id="toggleResponsiveCategory"
            class={style.toggleResponsiveCategory}
            hidden
          />
            ...
            <div class={style['modal-katalog-category-main']}>
              {katalog.map((item) => (
                <Link
                  ...
                  key={item.name}
                  class={[
                    style['modal-katalog-item'],
                    item.disabled
                      ? 'saturate-0 contrast-50 opacity-70 cursor-not-allowed pointer-events-none'
                      : '',
                  ]}
                  onClick$={() => {
