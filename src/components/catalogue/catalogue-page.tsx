...
export const CataloguePage = component$<CataloguePageProps>(
  ({ components, katalogTitle, url, kategori }) => {
    ...
    const mobileSidebarButton = (
      <div class="px-4">
        ...
        >
          {hideSidebar.value ? 'Filter' : 'Kembali'}
        </OutlinedButton>
      </div>
    );
    return (
        ...
        onPending={() => (
          <div class="py-4">
            ...
            <div class="flex flex-row pt-4 tablet:pt-0">
              <div
                class={`${
                  hideSidebar.value ? 'hidden' : ''
                } desktop:block desktop:m-0`}
              >
                <Slot />
              </div>
              <div
                class={`flex-1 w-full px-3 desktop:p-0 ${
                  hideSidebar.value ? '' : 'hidden'
                } tablet:block`}
              >
