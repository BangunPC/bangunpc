...
export default component$(() => {
  const jasa = [
    {
      icon: (
        <TbDevicesPc q:slot="icon" style={{ width: '24px', height: '24px' }} />
      ),
    ...
    },
    {
      ...
      title: 'Rakitanku',
      description:
        'Tak punya waktu atau bingung cara merakit PC sendiri? Tenang, kami dapat merakitkan PC impian Anda sampai siap pakai',
    },
    {
      icon: (
        <TbDeviceDesktopCog
      ...
      description:
        'Ada komponen PC atau laptop yang bermasalah? Kami siap membantu Anda memperbaikinya dengan teknisi yang telah berpengalaman',
    },
  ];
  return (
    <div id="jasa" class={styles['jasa-section']}>
      <header class={styles['jasa-header']}>
        ...
        <span class={styles['jasa-subtitle']}>
          Kami menyediakan beragam layanan yang dapat Anda pilih sesuai dengan
          kebutuhan Anda.
        </span>
      </header>
