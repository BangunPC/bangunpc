      ...
      <div class={styles['banding-left-wrapper']}>
        <div class={styles['banding-left']}>
          ...
          <main class={styles['banding-main']}>
            Temukan penawaran terbaik dengan mudah! Kami adalah tempat terbaik
            untuk membandingkan harga dari berbagai toko online terkemuka.
            Dapatkan informasi harga yang akurat dan hemat waktu serta uang saat
            berbelanja online dengan bantuan kami.
          </main>
        </div>
      </div>
