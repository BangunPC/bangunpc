            ...
            >
                ...
                <ModalContent class='flex flex-col max-w-md'>
                    <div class="flex justify-end">
                        <FilledButton onClick$={() => { showModalReset.value = false }} class='aspect-square fixed ml-auto rounded-xl mr-4 mt-4'>
                            <TbX />
                        </FilledButton>
                    </div>
                    <div class='flex flex-col p-8 gap-2'>
                        ...
                        <span class='my-4 leading-[150%]'>
                            Apakah anda yakin ingin mereset simulasi rakit PC? Komponen yang telah ditambahkan akan hilang dan tidak bisa dikembalikan
                        </span>
                        <span class='flex gap-1'>
                            <FilledButton class='flex-1' onClick$={() => {
                                showModalReset.value = false
                                onConfirm$;
                            }}>Reset</FilledButton>
                            <OutlinedButton class='flex-1' onClick$={() => { showModalReset.value = false }}>Cancel</OutlinedButton>
                        </span>
                    </div>
                </ModalContent>
            </Modal>
