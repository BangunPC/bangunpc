    ...
    <>
      <div class="flex flex-col w-full py-16 px-8 gap-12">
        ...
        <div class="flex flex-col gap-3 mx-auto w-fit text-center">
          <span class="text-4xl font-bold">Pilih Jasa Servis</span>
        ...
        <OutlinedButton class="w-44 h-14 mx-auto">Lihat Semua</OutlinedButton>
        {/* mitra jasa servis */}
        <div class="flex flex-col gap-3 mx-auto w-fit text-center">
          <span class="text-4xl font-bold">Mitra Jasa Servis PC</span>
          <span class="text-2xl text-[#74738A]">
        ...
        <div class="m-auto flex justify-between py-24 max-w-6xl w-full">
          <div class="flex flex-1 flex-col gap-12">
            <div class="flex flex-col">
              <span class="font-bold text-lg">Ada Pertanyaan?</span>
              <span class="font-bold text-5xl">Boleh tanya-tanya dulu</span>
            </div>
          ...
          <div class="flex flex-1 flex-col leading-6 justify-center">
            ...
            >
              ...
              <FaChevronDownSolid
                class={[
                  'inline-block ml-auto transition-transform ',
                  index.value == 0 ? 'rotate-180' : 'rotate-0',
                ]}
              />
            </span>
            {index.value == 0 &&
              'Biaya jasa rakit PC bervariasi tergantung pada spesifikasi yang Anda pilih. Hubungi kami untuk penawaran yang tepat.'}
            <span
              class="flex font-semibold text-xl py-4 rounded-md hover:bg-white/20 cursor-default items-center px-2"
              onClick$={() => {
            ...
            >
              ...
              <FaChevronDownSolid
                class={[
                  'inline-block ml-auto transition-transform ',
                  index.value == 1 ? 'rotate-180' : 'rotate-0',
                ]}
              />
            </span>
            {index.value == 1 &&
              'Garansi bervariasi tergantung pada spesifikasi yang Anda pilih. Hubungi kami untuk penawaran yang tepat.'}
            <span
              class="flex font-semibold text-xl py-4 rounded-md hover:bg-white/20 cursor-default items-center px-2"
              onClick$={() => {
            ...
            >
              ...
              <FaChevronDownSolid
                class={[
                  'inline-block ml-auto transition-transform ',
                  index.value == 2 ? 'rotate-180' : 'rotate-0',
                ]}
              />
            </span>
            {index.value == 2 &&
              'Proses pengerjaan rakit PC bervariasi tergantung pada spesifikasi yang Anda pilih. Hubungi kami untuk penawaran yang tepat.'}
          </div>
        </div>
      </div>
    </>
...
const ServisCard = component$<ServisCardProps>(
  ({ title, price, shop, location, stars }) => {
    return (
      <>
            ...
            <div class="flex flex-col gap-2">
              ...
              <span class="flex text-[#74738A] items-center">
                <Shop
                  width="20"
                  height="20"
                  class="fill-primary stroke-white mr-1"
                />
                {shop}
              </span>
              <span class="flex text-[#74738A] items-center">
    ...
    <>
      <div class="bg-white flex flex-col rounded-2xl shadow-br w-[256px] h-[256px]">
        <div class="flex flex-col m-auto justify-evenly text-center gap-8">
          <div>
            <div class="m-auto rounded-full w-[128px] h-[128px] bg-primary"></div>
          </div>
          <div class="flex flex-col">
            ...
            <span class="text-xl font-semibold">Servis Laptop.ID</span>
          </div>
        </div>
      </div>
    </>
